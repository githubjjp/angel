...
public class FilterElementEntity {
    ...
    private int invalidDateFilter1;//第1个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter2;//第2个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter3;//第3个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter4;//第4个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter5;//第5个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter6;//第6个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter7;//第7个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter8;//第8个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter9;//第9个滤芯的失效时间（固定）
    ...
    private int invalidDateFilter10;//第10个滤芯的失效时间（固定）
